...
target_region="NW_006272005.1:5268493-5269634" # target region +-10 base
REF=~/main/sequence/N_bri/GCF_000239395.1_NeoBri1.0_genomic.fna # reference
BWA_REF=~/main/sequence/N_bri/Nbri_bwa # reference for bwa
threads="32" # number of threads
fastp_threads="16" # number of threads for fastp (up to 16)
