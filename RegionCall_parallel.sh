...
REF="$HOME/path/to/reference.fasta" # # Path to reference
BWA_REF="$HOME/path/to/bwa_index"                                   # Path to mapping index
WORK_DIR="$HOME/path/to/working_directory"                                       # Path to working directory
